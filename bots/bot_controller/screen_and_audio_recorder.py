    ...
    def start_recording(self, display_var):
        ...
        if self.audio_only:
            ...
            ffmpeg_cmd = [
                ...
                "libx264",
                "-preset",
                str(settings.RECORDING_VIDEO_PRESET),
                "-crf",
                str(settings.RECORDING_VIDEO_CRF),
                "-maxrate",
                str(settings.RECORDING_VIDEO_MAXRATE),
                "-bufsize",
                str(settings.RECORDING_VIDEO_BUFSIZE),
                "-pix_fmt",
                "yuv420p",
                "-g",
                str(settings.RECORDING_VIDEO_GOP),
                "-c:a",
                "aac",
                "-strict",
                "experimental",
